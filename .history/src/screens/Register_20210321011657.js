    ...
    const freeRegister = () => {
      ...
      let openImagePickerAsync = async () => {
        ...
        if (pickerResult.cancelled === true) {
          ...
          let dataUriToBlob = new FormData()
      
          let blobCreated = dataUriToBlob.append("Blob File", blobObject);
          setImg(           let blobCreated = dataUriToBlob.append("Blob File", blobObject);
 );
      }
