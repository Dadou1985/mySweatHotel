    ...
    return (
        <KeyboardAvoidingView style={styles.container}>
            ...
            <View style={{flex: 2, flexDirection: "column", width: "100%", padding: 10, alignItems: "center"}}>
              ...
              <Divider />
              <View style={{flexDirection: "row", justifyContent: "space-around", width: "100%", marginTop: 25, marg}}>
              ...
              <Button title="Actualiser votre profil" type="clear" onPress={() => setUpdateProfile(true)} /> 
            </View>
