    ...
    return (
        <KeyboardAvoidingView behavior="padding" style={styles.container}>
            ...
            <View style={styles.inputContainer}>
                <Button placeholder="Date de réservation" type="button" value={moment(date).format('L')} 
                onPress={handleShowDate} />
                <Input placeholder="Heure de réservation" type="button" value={moment(hour).format('LT')} 
            ...
            <Button onPress={handleSubmit} containerStyle={styles.button} title="Réserver maintenant" />
