...
import { KeyboardAvoidingView, StyleSheet, Text, View, Image, Input, TouchableOpacity, Modal } from 'react-native';
                ...
                Alert.alert('Modal has been closed.');
                    ...
                    <View style={styles.centeredView}>
                        <View style={styles.modalView}>
                            <Input placeholder="Entrez votre numéro de chambre" autofocus type="number" value={room} 
