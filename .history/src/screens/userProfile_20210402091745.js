...
const UserProfile = ({navigation}) => {
    ...
    const [updateCheckout, setUpdateCheckout] = useState(true)
...
return (
        <KeyboardAvoidingView style={styles.container}>
            ...
            <Overlay isVisible={updatePhoto} onBackdropPress={() => setUpdateProfile(false)}>
              <View style={{width: "70%"}}>
                <Text style={{textAlign: "center", fontWeight: "bold", fontSize: 18, marginBottom: 15}}>Changer ma photo de profil</Text>
                <Button title="Confirmer" style={{marginTop: 1, marginBottom: 1}} />
                <View>
