...
return (
        <KeyboardAvoidingView style={styles.container}>
            ...
            <Overlay>
              <View style={{width: "70%"}}>
                <Text style={{textAlign: "center", fontWeight: "bold", fontSize: 18}}>Changer ma photo de profil</Text>
                <Text style={{textAlign: "center", fontWeight: "bold", fontSize: 18}}>Demande de confirmation</Text>
                <View>
                  <Text>Vous serez redirigez vers l'écran d'accueil à l'issue de cette opération</Text>
                  <Button />
                </View>
              </View>
            </Overlay>
