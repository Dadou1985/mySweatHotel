...
import ModalDropdown from 'react-native-modal-dropdown';import RegionDetails from '../../hotels/regionDetailsSheet.json'
        ...
        <KeyboardAvoidingView style={styles.container}>
            ...
            <Picker
                ...
                {RegionDetails.map(region =>(
                    <Picker.Item label={region.region} value={region.region} index={region.number} />
                ))
                }
            </Picker>
            {region !== "Sélectionner une région" ? <Picker
