    ...
    return (
        <View style={styles.container}>
            ...
            <View style={{flex: 2, flexDirection: "column", width: "100%", padding: 10, alignItems: "center"}}>
              ...
              <Text style={{fontSize: 14}}>{userDB.hotelName}</Text>
              <Text style={{fontSize: 14}}>Vous occupez actuellement la chambre {userDB.room}</Text>
              <Text>Check-out prévu pour le {moment(userDB.checkoutDate).format('LL')}</Text>
            </View>
