    ...
    return (
        <KeyboardAvoidingView style={styles.container}>
            ...
            <View style={styles.containerText}>
                ...
                <View>
                    <Text>Aidez-nous à </Text>
                    <Button onPress={() => setShowModalRegion(true)} containerStyle={styles.button} title="Sélectionner une région" />
                    <Button onPress={() => setShowModalDepartement(true)} containerStyle={styles.button} title="Connexion" />
                    <Button onPress={() => setShowModalArrondissement(true)} containerStyle={styles.button} title="Connexion" />
                    <Button onPress={() => setShowModalHotel(true)} containerStyle={styles.button} title="Connexion" />
                </View>
            </View>
            <Modal 
            animationType="slide"
