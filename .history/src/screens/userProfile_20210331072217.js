...
const UserProfile = () => {
    ...
    const handleSubmit = async(url) => {
      ...
      setCheckoutDate(userDB.checkoutDate)
      setVisible(false)
            ...
            <Overlay isVisible={visible} onBackdropPress={() => setVisible(false)}>
              <View style={{width: "100%", flexDirection: "column", alignItems: "center", padding: 10}}>
                ...
                <View style={styles.inputContainer}>
                  ...
                  <Button style={{marginBottom: 20}} onPress={() => setShowDate(true)} type='clear' title="Modifier ma date de check-out" />
                  <TouchableOpacity style={{flexDirection: "row", width: 300, alignItems: "center", justifyContent: "center", marginBottom: 30}} onPress={pickImage}>
                    <MaterialIcons name="add-a-photo" size={24} color="grey" />                    
                    <Text style={{fontSize: 20, color: "grey", marginLeft: 10}}>Modifier ma photo</Text>
                  </TouchableOpacity>
                </View>
