        ...
        <KeyboardAvoidingView style={styles.container}>
            ...
            <View style={styles.containerText}>
                ...
                <View style={styles.buttonView}>
                    ...
                    {room !== null &&
                        <Button onPress={() => setShowDate(true)} containerStyle={styles.button} title="Date de fin de séjour" />}    
                </View>
                <View style={{width: 350, marginTop: 20}}>
                    {hotel !== "Sélectionner votre hôtel" &&
                        <Input placeholder="Entrer votre numéro de chambre" type="number" value={room} 
                        onChangeText={(text) => setRoom(text)} style={{textAlign: "center", marginBottom: 10}} />}
                </View>
            </View>
