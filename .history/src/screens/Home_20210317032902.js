...
const Home = () => {
    return (
        <KeyboardAvoidingView style={styles.container}>
            ...
            <Image source={{uri: "https://i.pinimg.com/originals/cb/59/ff/cb59ffb54f7bcca4dbbc1517a65c1f01.jpg"}} style={{width: 200, height: 200, position: "absolute", borderRadius: 100, top: }} />
            <View style={styles.containerImg}>
