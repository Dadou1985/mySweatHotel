...
return (
        <KeyboardAvoidingView style={styles.container}>
            ...
            <Overlay isVisible={updatePhoto} onBackdropPress={() => setUpdatePhoto(false)}>
              <View style={{width: "70%"}}>
                <Text style={{textAlign: "center", fontWeight: "bold", fontSize: 18, marginBottom: 15}}>Etes-vous shanger ma photo de profil</Text>
            ...
            <Overlay isVisible={updateCheckout} onBackdropPress={() => setUpdateCheckout(false)}>
              <View style={{width: "70%"}}>
                <Text style={{textAlign: "center", fontWeight: "bold", fontSize: 18, marginBottom: 15}}>Changer la date de mon check-out</Text>
                <Button title="Confirmer" style={{marginTop: 1, marginBottom: 1}} onPress={() => {
