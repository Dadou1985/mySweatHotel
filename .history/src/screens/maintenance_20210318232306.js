...
const Maintenance = () => {
    ...
    return (
        <KeyboardAvoidingView behavior="padding" style={styles.container}>
            ...
            <View>
                <TouchableOpacity style={{flexDirection: "row", width: 300, alignItems: "center"}}>
                <MaterialIcons name="add-a-photo" size={24} color="black" />                    <Text style={{fontSize: 20, color: "grey", marginLeft: 5}}>Ajouter une image</Text>
                </TouchableOpacity>
            </View>
