...
const Home = () => {
    return (
        <KeyboardAvoidingView style={styles.container}>
            ...
            <View style={styles.containerImg}>
                <Image source={{uri: "https://media1.thehungryjpeg.com/thumbs2/ori_3591356_9p73ir53uuip8wqyeb4svl7t15biwcuhmwztailk_alarm-clock-icon.jpg"}} style={{width: 100, height: 100}} />
