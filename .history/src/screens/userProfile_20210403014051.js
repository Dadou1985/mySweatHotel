...
const UserProfile = ({navigation}) => {
  ...
  const handleChangeEmail = () => {
    ...
    const fadeAnim = useRef(new Animated.Value()).current;
    ...
    return (
        <KeyboardAvoidingView style={styles.container}>
            ...
            <View style={{flex: 2, flexDirection: "column", width: "100%", padding: 10, alignItems: "center"}}>
              ...
              <Button title="Cliquez ici pour plus de services" type="clear" onPress={() => setUpdateProfile(true)} /> 
              <ClickNwaitDrawer fadeAnim={fadeAnim} />
            </View>
