...
const Information = () => {
    ...
    const [showModalDepartement, setShowModalDepartement] = useState(true)
        ...
        <KeyboardAvoidingView style={styles.container}>
            ...
            <View style={styles.containerText}>
                ...
                <View>
                    ...
                    <Button onPress={() => setShowModalRegion(true)} containerStyle={styles.button} title="Sélectionner une région" />
                    {region !== "Sélectionner une région" ?
                        <Button onPress={() => setShowModalDepartement(true)} containerStyle={styles.button} title="Sélectionner un département" /> : <></>}
                    {region !== "Sélectionner une région" ?
                        <Button onPress={() => setShowModalDepartement(true)} containerStyle={styles.button} title="Sélectionner un département" /> : <></>}{region !== "Sélectionner une région" ?
                        <Button onPress={() => setShowModalDepartement(true)} containerStyle={styles.button} title="Sélectionner un département" /> : <></>}{region !== "Sélectionner une région" ?
                        <Button onPress={() => setShowModalDepartement(true)} containerStyle={styles.button} title="Sélectionner un département" /> : <></>}    
                    <Button onPress={() => setShowModalArrondissement(true)} containerStyle={styles.button} title="Sélectionner un arrondissement" />
                    <Button onPress={() => setShowModalHotel(true)} containerStyle={styles.button} title="Sélectionner votre hôtel" />
                </View>
            </View>
            <Modal 
            animationType="slide"
