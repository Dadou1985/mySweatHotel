        ...
        <KeyboardAvoidingView style={styles.container}>
            ...
            <View style={styles.containerText}>
                ...
                <View>
                    ...
                    <Button onPress={() => setShowModalDepartement(true)} containerStyle={styles.button} title="Sélectionner unSélectionner un" />
                    <Button onPress={() => setShowModalArrondissement(true)} containerStyle={styles.button} title="Sélectionner unSélectionner un" />
                    <Button onPress={() => setShowModalHotel(true)} containerStyle={styles.button} title="Sélectionner unSélectionner un" />
                </View>
            </View>
            <Modal 
            animationType="slide"
