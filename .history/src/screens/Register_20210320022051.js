...
const Register = ({ navigation }) => {
    ...
    const freeRegister = ({email, password, name}) => {
    ...
    return (
        <KeyboardAvoidingView style={styles.container}>
            ...
            <View style={styles.inputContainer}> 
                ...
                onChangeT={(text) => setConfirmPassword(text)}
            ...
            <Button containerStyle={styles.button} title="Créer un compte" onPress={() => freeRegister(email, password, name)} />
