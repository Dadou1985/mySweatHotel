        ...
        <KeyboardAvoidingView style={styles.container}>
            ...
            <View style={styles.containerBottom}>
                <TouchableOpacity style={styles.button}>
                    <Image source={{uri: "https://image.flaticon.com/icons/png/512/62/62834.png"}} style={styles.img} onPress={() => navigation.navigate('Chat')} />
                </TouchableOpacity>           
                <TouchableOpacity style={styles.button}>
                    <Image source={{uri: "https://cdn2.iconfinder.com/data/icons/car-11/100/taxi3-512.png"}} style={styles.img} onPress={() => navigation.navigate('Chat')} />
                </TouchableOpacity>
            </View>
