...
const UserProfile = ({navigation}) => {
    ...
    const [checkoutDate, setCheckoutDate] = useState(new Date(userDB.checkoutDate))
    ...
    const onChange = async(event, selectedDate) => {
      ...
      await setShowDate(Platform.OS === 'ios');
      await setCheckoutDate(currentDate);
      return checkoutDateAlert()
    };
