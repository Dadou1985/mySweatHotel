    ...
    return (
        <KeyboardAvoidingView style={styles.container}>
            ...
            <View style={{flex: 2, flexDirection: "column", width: "100%", padding: 10, alignItems: "center"}}>
              ...
              <Text style={{fontSize: 14, marginBottom: 10}}>Check-out prévu pour le {moment(userDB.checkoutDate).format('LL')}</Text>
              <Button title="Actualiser votre profil" containerStyle={styles.button} />            
            </View>
