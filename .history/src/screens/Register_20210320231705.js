    ...
    const freeRegister = () => {
      ...
      let openImagePickerAsync = async () => {
        ...
        if (pickerResult.cancelled === true) {
          ...
          setImg({ localUri: pickerResult.uri });
      }
    ...
    return (
        <KeyboardAvoidingView style={styles.container}>
            ...
            <View style={{marginBottom: 15}}>
                <TouchableOpacity style={{flexDirection: "row", width: 300, alignItems: "center", justifyContent: "center"}} onPress={openImagePickerAsync} onchange={handleImgChange}>
