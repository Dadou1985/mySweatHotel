...
const UserProfile = () => {
    ...
    const photoAlert = () => {
      Alert.alert(
        ...
        [
          {
            text: "Oui", onPress: (event) => handleChangePhotoUrl(event)
...
return (
        <KeyboardAvoidingView style={styles.container}>
            ...
            <View style={{flex: 2, flexDirection: "column", width: "100%", padding: 10, alignItems: "center"}}>
              ...
              <Button title="Actualiser votre photo" containerStyle={styles.button} onPress={() => setVisible(true)} /> 
              <Button title="Actualiser votre check-out" containerStyle={styles.button} onPress={() => setVisible(true)} />            
            </View>
            ...
            {userDB.checkoutDate !== moment(checkoutDate).format('L') && checkoutDateAlert}
