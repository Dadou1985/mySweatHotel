...
const Information = () => {
    ...
    const [showDat, setShow] = useState(false)
        ...
        <KeyboardAvoidingView style={styles.container}>
            ...
            <View style={styles.containerText}>
                ...
                <View style={styles.buttonView}>
                    ...
                    {hotel === "Sélectionner votre hôtel" &&
                        <Button onPress={() => setShowModalRegion(true)} containerStyle={styles.button} title={region} />}
                    {hotel === "Sélectionner votre hôtel" && region !== "Sélectionner une région" ?
                        <Button onPress={() => setShowModalDepartement(true)} containerStyle={styles.button} title={departement} /> : <></>}
                    {hotel === "Sélectionner votre hôtel" && departement === "PARIS" && departement !== "Sélectionner une département" ?
                ...
                <View style={{width: 350, marginTop: 20}}>
                    {hotel !== "Sélectionner votre hôtel" &&
                        ...
                        onChangeText={(text) => setRoom(text)} style={{textAlign: "center"}} />}
                    {room !== null &&
                        <Button onPress={() => setShowModalHotel(true)} containerStyle={styles.button} title="Date de fin de séjour" />}    
                </View>
            </View>
