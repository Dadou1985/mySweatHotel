...
return (
        <KeyboardAvoidingView style={styles.container}>
            ...
            <View style={{flex: 2, flexDirection: "column", width: "100%", padding: 10, alignItems: "center"}}>
              ...
              <Button title="Actualiser votre photo" containerStyle={styles.button} onPress={(event) => handleChangePhotoUrl} /> 
              <Button title="Actualiser votre checkout" containerStyle={styles.button} onPress={() => setVisible(true)} /> 
            </View>
