...
export default function HotelRegitrator() {
    ...
    const hotelRegistrator = ({country, hotelId, arrondissement, hotelName, classement, adresse, room, phone, mail, website, region, departement, code_postal, city, lat, lng}) => {
        return this.db.collection("mySweatHotel")
        .doc("country")
        .collection(country)
        .doc("region")
        .collection(region)
