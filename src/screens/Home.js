...
const Home = ({ navigation }) => {
    ...
    const [itemDaily, setItemDaily] = useState(true)
    const [itemJourney, setItemJourney] = useState(true)
...
,            createdAt: new Date(),
    ...
    const handleItemDateCreation = (item) => {
        return Object.defineProperty(userDB, item, {value : moment(new Date()).format('L'),
            writable : true,
            configurable : true,
            enumerable : true})
    }
    ...
    return (
        <KeyboardAvoidingView style={styles.container}>
            ...
            <View style={styles.containerTop}>
                ...
                style={{width: 150, height: 150, position: "absolute", borderRadius: 100, top: 260}}
